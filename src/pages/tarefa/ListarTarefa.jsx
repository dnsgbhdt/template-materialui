...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="outlined" color="primary" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
        ...
        <CardActions>
            <Button color='primary' size="small" variant="text" onClick={handleOpen}>Criar Tarefa</Button>
            <Button color='error' size="small" variant="text">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
